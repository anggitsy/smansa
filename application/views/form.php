...
<head>
    ...
    <!-- Wait Me Css -->
    <link href="<?=base_url(); ?>plugins/waitme/waitMe.css" rel="stylesheet" />
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=base_url(); ?>index.html">ADMINBSB - MATERIAL DESIGN</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="<?=base_url(); ?>pages/typography.html">
                            <i class="material-icons">text_fields</i>
                            <span>Typography</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?=base_url(); ?>pages/helper-classes.html">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="<?=base_url(); ?>pages/widgets/cards/basic.html">Basic</a>
                                    </li>
                                    <li>
                                        <a href="<?=base_url(); ?>pages/widgets/cards/colored.html">Colored</a>
                                    </li>
                                    <li>
                                        <a href="<?=base_url(); ?>pages/widgets/cards/no-header.html">No Header</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="<?=base_url(); ?>pages/widgets/infobox/infobox-1.html">Infobox-1</a>
                                    </li>
                                    <li>
                                        <a href="<?=base_url(); ?>pages/widgets/infobox/infobox-2.html">Infobox-2</a>
                                    </li>
                                    <li>
                                        <a href="<?=base_url(); ?>pages/widgets/infobox/infobox-3.html">Infobox-3</a>
                                    </li>
                                    <li>
                                        <a href="<?=base_url(); ?>pages/widgets/infobox/infobox-4.html">Infobox-4</a>
                                    </li>
                                    <li>
                                        <a href="<?=base_url(); ?>pages/widgets/infobox/infobox-5.html">Infobox-5</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/alerts.html">Alerts</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/animations.html">Animations</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/badges.html">Badges</a>
                            </li>

                            <li>
                                <a href="<?=base_url(); ?>pages/ui/breadcrumbs.html">Breadcrumbs</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/buttons.html">Buttons</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/collapse.html">Collapse</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/colors.html">Colors</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/dialogs.html">Dialogs</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/icons.html">Icons</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/labels.html">Labels</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/list-group.html">List Group</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/media-object.html">Media Object</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/modals.html">Modals</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/notifications.html">Notifications</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/pagination.html">Pagination</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/preloaders.html">Preloaders</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/progressbars.html">Progress Bars</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/range-sliders.html">Range Sliders</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/sortable-nestable.html">Sortable & Nestable</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/tabs.html">Tabs</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/thumbnails.html">Thumbnails</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/tooltips-popovers.html">Tooltips & Popovers</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/ui/waves.html">Waves</a>
                            </li>
                        </ul>
                    </li>
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            <li class="active">
                                <a href="<?=base_url(); ?>pages/forms/basic-form-elements.html">Basic Form Elements</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/forms/advanced-form-elements.html">Advanced Form Elements</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/forms/form-examples.html">Form Examples</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/forms/form-validation.html">Form Validation</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/forms/form-wizard.html">Form Wizard</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/forms/editors.html">Editors</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?=base_url(); ?>pages/tables/normal-tables.html">Normal Tables</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/tables/jquery-datatable.html">Jquery Datatables</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/tables/editable-table.html">Editable Tables</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?=base_url(); ?>pages/medias/image-gallery.html">Image Gallery</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/medias/carousel.html">Carousel</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?=base_url(); ?>pages/charts/morris.html">Morris</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/charts/flot.html">Flot</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/charts/chartjs.html">ChartJS</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/charts/sparkline.html">Sparkline</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/charts/jquery-knob.html">Jquery Knob</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?=base_url(); ?>pages/examples/sign-in.html">Sign In</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/examples/sign-up.html">Sign Up</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/examples/forgot-password.html">Forgot Password</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/examples/blank.html">Blank Page</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/examples/404.html">404 - Not Found</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/examples/500.html">500 - Server Error</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?=base_url(); ?>pages/maps/google.html">Google Map</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/maps/yandex.html">YandexMap</a>
                            </li>
                            <li>
                                <a href="<?=base_url(); ?>pages/maps/jvectormap.html">jVectorMap</a>
                            </li>
                        </ul>
                    </li>
                    <li>
