        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <!-- Call Search -->
                    <li><a href="http://localhost/smansa/c_pengelola/logout"><i class="material-icons">exit_to_app</i></a></li>
                    <!-- #END# Call Search -->
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li><a href="<?php base_url(); ?>c_pengelola/logout"><i class="material-icons">input</i>Log Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="<?php echo $prasarana_header; ?>">
                        <a href="<?php echo base_url(); ?>c_pengelola/page_kelola_prasarana">
                            <i class="material-icons">business</i>
                            <span>Kelola Prasarana Sarana</span>
                        </a>
                    </li>
                    <li class="<?php echo $student_header; ?>">
                        <a href="<?php echo base_url(); ?>c_pengelola/page_kelola_siswa">
                            <i class="material-icons">people</i>
                            <span>Kelola User Siswa</span>
                        </a>
                    </li>
                    <li class="<?php echo $rental_header; ?>">
                        <a href="<?php echo base_url(); ?>c_pengelola/page_kelola_peminjaman">
                    ...
                    <li class="<?php echo $report_header; ?>">
                        <a href="">
